...
%
%   Inputs:
%       data        time series data organized as TIME x NODES.
%       window   window length (time points).
%       direction mirrored or forward facing window
%       trim            determines whether to trim data or append with zeros.
%
%       Note: see Shine et al (2015) for a discussion of window length and smoothing options.
%
%   Outputs:
%       MTD: time-varying connectivity matrix
